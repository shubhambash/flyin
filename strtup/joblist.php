...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
  ...
  $sql = "SELECT `company_name`, `job_type`, `job_title`, `job_category`, `work_from_home`, `location`, `start_date`, `duration`, `paid`, `stipend` FROM job_details WHERE  job_category = '$category' AND work_from_home = $wfh AND stipend BETWEEN $low AND $high";
...

{
  ...
  //if request has been made from categories

  if(!isset($_GET['search']))
  {
     echo  '<h1 class="text-center pt-5">Please search for a category</h1>';
     exit();
  }
        ...
        '
              ...
              <div class="card cardDiv " style="width: 30rem; margin: auto;display: block;">
                  <div class="card-body">
                    ...
                    <div><span style="color:green"><i class="fas fa-map-marker-alt "></i></span>&nbsp&nbsp&nbsp'. $location .'</div>
                    <div class="row pt-2 pb-2">
                    <div class="col-md-4 col-sm-4">Starts: '. $mysqldate .'</div>
                    <div class="col-md-4 col-sm-4">Duration: '. $duration .' days</div>
                    <div class="col-md-4 col-sm-4">Stipend: &#8377;'. $stipend .'</div>
                    ...
                    <div class="pt-4 pb-3" style="float: right;"><a role="button" class="btn btn-primary btn-sm mb-1"  href="posted_jobs_pages/view_details.php?job_id='. $id .'&apply=true">view details</a> </div>
...
// prevent confirm resubmission page

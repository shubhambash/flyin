...
// handles the user input from _prExperienceModal.php
...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    $existUser = "SELECT * FROM `pr_experience_details` WHERE user_email='$user_email'";
    ...
    if($numRows == 0)
    {
        ...
        if($numUser == 1)
        {
            ...
            if(isset($_GET['edit']) && $_GET['edit'] == "true")
            {
                ...
                {
                    mysqli_stmt_bind_param($stmt,"sssssss",$title1, $companyName1, $title2, $companyName2, $title3, $companyName3, $user_email);
            ...
            if($stmt = mysqli_prepare($conn, $sql))
            {
                mysqli_stmt_bind_param($stmt,"sssssss", $user_email, $title1, $companyName1, $title2, $companyName2, $title3, $companyName3);
                mysqli_stmt_execute($stmt);

...
<!-- Modal -->
<div class="modal fade" id="prExperience" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-center" id="staticBackdropLabel">Position of Responsibility Experience</h5>
      ...
      <div class="modal-body">
          ...
          <!-- modal body goes here -->
            <form action="../partials/user_resume/handle_experience/_handle_prExperience.php?edit=true" method="post">
                  ...
                  <p>List down the <strong> most recent </strong> Positions of responsibility</p>
                  ...
                  <div class="row">
                        ...
                        <label class="form-label text-center">Organisation/Company</label>
